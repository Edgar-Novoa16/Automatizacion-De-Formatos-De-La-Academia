...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_FILES["Comision"]) && $_FILES["Comision"]["error"] == UPLOAD_ERR_OK) {
      ...
      $stmt = $conn->prepare("UPDATE from_comisiones SET Comision = ?,  Estatus =  'COMPLETA' WHERE Folio = ?");
...
<head>
  ...
  <script src="../conexiones/CargaComite.php"></script>
    ...
    <title>Subir Comision Sellada</title>
</head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link" href=""  style="color: white;">COMISION SELLADA</a>
        </div>
      </div>
    </div>
  </nav>
...
<form action="<?=$_SERVER['PHP_SELF']?>" id="Formulario_Comisiones" class="campos_registro" accept-charset="utf-8" method="post" enctype="multipart/form-data">
    <h1 style="color: #0a0707; font-size: 20px;">Subir Comision Sellada</h1>
    <p></p>
