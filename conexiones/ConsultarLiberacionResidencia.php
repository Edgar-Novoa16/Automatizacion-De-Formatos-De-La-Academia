  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
		...
		<div class="container">
					<p class="copyright"> <img src="../img/logo.jpg" width="25" heigth="25"> <br>ANEXO XXXIII.FORMATO DE LIBERACIÓN DE PROYECTO PARA LA TITULACIÓN INTEGRAL</br></p>
				</div>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "CargaLiberacionResidencia.php"
