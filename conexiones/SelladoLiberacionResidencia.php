...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_FILES["Constancia"]) && $_FILES["Constancia"]["error"] == UPLOAD_ERR_OK) {
      ...
      $stmt = $conn->prepare("UPDATE from_liberacion_residencia SET Constancia = ?,  Estatus =  'COMPLETA' WHERE N_Control = ?");
...
<head>
    ...
    <title>Subir  Liberacion Residencia Sellada </title>
</head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link" href=""  style="color: white;">LIBERACION SELLADA</a>
        </div>
      </div>
    </div>
  </nav>
...
<form action="<?=$_SERVER['PHP_SELF']?>" id="Formulario_Comite" class="campos_registro" accept-charset="utf-8" method="post" enctype="multipart/form-data">
    <h1 style="color: #0a0707; font-size: 20px;">Subir Liberacion Sellada</h1>
    <p></p>
