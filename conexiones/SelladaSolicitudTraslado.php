...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_FILES["Solicitud"]) && $_FILES["Solicitud"]["error"] == UPLOAD_ERR_OK) {
      ...
      $stmt = $conn->prepare("UPDATE from_solicitud_traslado SET Solicitud = ?,  Estatus =  'COMPLETA' WHERE N_Control = ?");
...
<head>
    ...
    <title>Subir Solicitud de Traslado Sellada </title>
</head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link" href=""  style="color: white;">SOLICITUD DE TRASLADO SELLADA</a>
        </div>
      </div>
    </div>
  </nav>
